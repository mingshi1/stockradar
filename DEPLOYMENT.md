# V1.0.0-rc4.10 Deployment Guide

V1.0.0-rc4.10 第一次把“开发项目”升级成“可发布项目”。
...
→ Inno Setup
→ installer\output\StockEventRadar-Setup-1.0.0-rc4.10.exe
```
...
```powershell
git tag v1.0.0-rc4.10.1
git push origin v1.0.0-rc4.10.1
```
...
```text
StockEventRadar.exe
StockEventRadar-Setup-1.0.0-rc4.10.exe
```
