# V1.0.0-rc4.12 Deployment Guide

V1.0.0-rc4.12 第一次把“开发项目”升级成“可发布项目”。
...
→ Inno Setup
→ installer\output\StockEventRadar-Setup-1.0.0-rc4.12.exe
```
...
```text
StockEventRadar.exe
StockEventRadar-Setup-1.0.0-rc4.12.exe
```
