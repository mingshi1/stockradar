# V1.0.0-rc4.18 Deployment Guide

V1.0.0-rc4.18 第一次把“开发项目”升级成“可发布项目”。
...
→ Inno Setup
→ installer\output\StockEventRadar-Setup-1.0.0-rc4.18.exe
```
...
```text
StockEventRadar.exe
StockEventRadar-Setup-1.0.0-rc4.18.exe
```
